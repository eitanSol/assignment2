...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None):
    ...
    scores, layer2_cache = affine_relu_forward(hidden_layer, self.params['W2'], self.params['b2'])
    ...
    dx2, dw2, db2 = affine_relu_backward(dL2, layer2_cache)
...
class FullyConnectedNet(object):
  ...
  def loss(self, X, y=None):
    ...
    for i in range(1, self.num_layers + 1):
      prelayer_output, cache[i-1] = affine_relu_forward(prelayer_output, self.params['W' + str(i)], self.params['b' + str(i)])
    pass
    scores = prelayer_output
    ############################################################################
    #                             END OF YOUR CODE                             #
    ############################################################################
